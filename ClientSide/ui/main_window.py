...
class MainInterfaccia(ctk.CTkFrame):
    ...
    def initUI(self):
        ...
        self.mostraDescrizioneTest = ctk.CTkLabel(self.testDescription, text="Descrizione test")
        self.mostraDescrizioneTest.pack(pady=10)


        self.testResult = self.informazioniTest.add("TEST RESULT")
        self.mostraRisultatoTest = ctk.CTkLabel(self.testResult, text="A").pack(pady=10)
    ...
    def selezionaPlugin(self, name):
        ...
        print("Plugin selezionato: "+self.plugin_selezionato)
